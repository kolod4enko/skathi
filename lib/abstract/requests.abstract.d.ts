import { Address, BlockHash, BlockNumber, BlockTag, FilterId, FilterOptionsByBlockHash, FilterOptionsByBlockNumber, RequestObject, TransactionHash, TransactionIndex } from "../interfaces/request";
export declare abstract class Requests {
...
//# sourceMappingURL=requests.abstract.d.ts.map